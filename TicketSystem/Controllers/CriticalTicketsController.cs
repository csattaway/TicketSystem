...
{
    public class CriticalTicketsController : Controller
    {
        ...
        {
            var tblTicket = db.tblTickets.SqlQuery("SELECT * FROM tblTicket WHERE idsSeverityType = 1 AND blnResolved = 0");
            return View(tblTicket.ToList());
        }

        // GET: CriticalTickets/Details/5
